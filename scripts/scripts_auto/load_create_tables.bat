...
psql -h %PGHOST% -p %PGPORT% -U %PGUSER% -d %PGDATABASE% -f "C:\Users\MTZ\Desktop\DB_RUTA\scripts\ddl\create_schema.sql"
if %errorlevel% neq 0 (
...
psql -h %PGHOST% -p %PGPORT% -U %PGUSER% -d %PGDATABASE% -f "C:\Users\MTZ\Desktop\DB_RUTA\scripts\ddl\create_tables.sql"
if %errorlevel% neq 0 (
